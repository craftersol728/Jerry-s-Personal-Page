      ...
      <Container>
        ...
        <Box display={{ md: 'flex' }}>
          <Box flexGrow={1}>
            ...
            <p>
              Just me ( Developer / Fast Learner / Quick Thinker / Problem
              Solver)
            </p>
          </Box>
          <Box
        ...
        <Section delay={0.1}>
          ...
          <Paragraph>
            Jerry is a freelance and a full-stack developer based in California
            ...
            not online, he loves hanging out with his friends and playing video
            games. Currently, he is working full time at a private tax
            preparation office, but he wishes he can work for a company that
            will need his skill to help people/useres have a better life.
          </Paragraph>
        ...
        <Section delay={0.2}>
          ...
          <BioSection>
            ...
            Returned to America after mastering the Chinese language and
          ...
          <BioSection>
            ...
            Started his own business and became a top % seller on ebay within
            the US 1 year later
          </BioSection>
          <BioSection>
            <BioYear>2023</BioYear>
            Completed the UC Berkeley Full Stack Coding Bootcamp and became a
        ...
        <Section delay={0.3}>
          ...
          <Paragraph>
            Helping People,Music, Playing and Developing Video Games, Anime,
            Manga, Movies, Playing Guitar,Pets and learning new coding
            languages.
          </Paragraph>
        </Section>
        ...
        <Section delay={0.3}>
          ...
          <List>
            <ListItem>
              <Link
                href="https://www.linkedin.com/in/jerry-wan-878944152/"
                target="_blank"
              >
                <Button
                  variant="ghost"
