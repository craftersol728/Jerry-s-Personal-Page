    ...
    >
      ...
      >
        ...
        >
          ...
          <LinkItem
            target="_blank"
            href="https://github.com/craftersol728"
            path={path}
            display="inline-flex"
            alignItems="center"
            style={{ gap: 4 }}
          ...
          <Box ml={2} display={{ base: 'inline-block', md: 'none' }}>
            <Menu isLazy id="navbar-menu">
              ...
              <MenuList>
                ...
                <MenuItem as={MenuLink} href="https://docs.google.com/document/d/e/2PACX-1vRy4zFlF6kdrh0Rq2LSzg1q7c8XEzbyfByZJSpGZsR_CtG0W4ZXNpTUWM0TM-0OqCk3su1tUgtT2z4P/pub">
                  Resume
                </MenuItem>
                <MenuItem
                  as={Link}
